...
path_slice = "dataset/sliced/skenario 8"
path_source = "dataset/source"
path_source_plat_hitam = "dataset/source/semua source"

# Template untuk proyeksi vertikal
pv_template = Utils.proyeksi_vertical(cv2.imread("dataset/templates/plate/template-plat-kuning.jpg", cv2.IMREAD_ANYCOLOR))
